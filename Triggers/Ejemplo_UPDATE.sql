...
-- despues le indicamos de que evento quiero que se dipare el trigger en este caso le indicadamos despues de que se haga un "UPDATE"

AFTER UPDATE ON items_facturas_tb
